...
<div class="container mx-auto px-6 py-6">
    ...
    <p class="text-slate-600 mt-1">Anda dapat melihat data anggota DPR dan data penggajian.</p>

    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden flex flex-col">
            <div class="p-6 flex justify-between items-center border-b">
                <h3 class="text-lg font-semibold">Data Anggota</h3>
                <a href="<?= base_url('/public/anggota') ?>" class="px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-md hover:bg-blue-600">Lihat Detail</a>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden flex flex-col">
            <div class="p-6 flex justify-between items-center border-b">
                ...
                <a href="<?= base_url('/public/penggajian') ?>" class="px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-md hover:bg-blue-600">Lihat Detail</a>
            </div>
            <div class="overflow-y-auto h-72">
                <table class="w-full text-sm">
                    <thead class="text-xs text-slate-700 uppercase bg-slate-50 sticky top-0">
                        <tr>
                            <th scope="col" class="px-6 py-4 text-left">ID</th>
                            <th scope="col" class="px-6 py-4 text-left">Nama Lengkap</th>
                            <th scope="col" class="px-6 py-4 text-left">Take Home Pay</th>
                        </tr>
                    </thead>
                    <tbody class="text-slate-600">
