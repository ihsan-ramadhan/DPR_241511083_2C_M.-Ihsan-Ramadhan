...
<body class="bg-slate-50 text-slate-800 flex flex-col min-h-screen">
    ...
    <div id="delete-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-xl shadow-xl p-6 w-full max-w-sm text-center">
            ...
            <p class="text-slate-600 mb-6">Apakah Anda yakin ingin menghapus <span id="delete-data-type"></span> <strong id="delete-item-name" class="text-slate-900"></strong>?</p>
            <div class="flex justify-center space-x-4">
    ...
    <script>
        ...
        if (deleteModal) {
            ...
            const deleteDataType = document.getElementById('delete-data-type');
            ...
            deleteLinks.forEach(link => {
                link.addEventListener('click', function(event) {
                    ...
                    deleteDataType.textContent = dataType;
